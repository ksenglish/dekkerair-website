...
export const ventilationTypes = [
  {
    ...
    images: [
      ...
      { src: '/images/positive-pressure/lite-4-room.webp', caption: 'SmartVent Lite+ — four rooms' },
      { src: '/images/positive-pressure/lite-6-room.webp', caption: 'SmartVent Lite+ — six rooms' },
      { src: '/images/positive-pressure/positive3-4-room.webp', caption: 'SmartVent Positive3 with room control' },
      { src: '/images/positive-pressure/advance-4-room.webp', caption: 'SmartVent Positive Advance' },
      { src: '/images/positive-pressure/advance-sensor.webp', caption: 'Positive Advance room sensor' },
      { src: '/images/positive-pressure/extension-kit.webp', caption: 'Insulated extension kit for extra outlets' },
    ],
...

  {
    ...
    icon: '🔥',
    calculator: null,
    diagram: { src: '/images/ventilation/heat-transfer-diagram.webp', alt: 'Warm air moved from the room with the fire to the cold rooms' },
    images: [
      { src: '/images/heat-transfer/one-room.webp', caption: 'Single room kit' },
      { src: '/images/heat-transfer/two-room.webp', caption: 'Two room kit' },
      { src: '/images/heat-transfer/three-room.webp', caption: 'Three room kit' },
    ],
...

  {
    ...
    icon: '💨',
    calculator: null,
    diagram: { src: '/images/ventilation/extraction-diagram.webp', alt: 'Extraction ducted to outside from the kitchen and bathroom' },
    images: [
      { src: '/images/extraction/extraction.webp', caption: 'Extraction at the source' },
      { src: '/images/extraction/vynco-fan.webp', caption: 'Inline extractor fan' },
    ],
