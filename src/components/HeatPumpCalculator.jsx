        ...
        {basket.length > 0 && (
          <div style={{
            ...
            <p style={{ fontSize: 13, color: 'var(--muted)', lineHeight: 1.7, marginTop: 14 }}>
              Prices include a standard installation. Pipe runs, wall access and electrical
              work vary between homes, so we confirm the whole price in writing after we've
              seen the job.
            </p>
